package com.example.JPA.study.springtx.exception

import com.example.JPA.study.logger
import com.example.JPA.study.springtx.exception.code.MyException
import com.example.JPA.study.springtx.exception.code.RollbackService
...
class RollBackTest {
    ...
    fun runtimeException() {
         ...
         * Getting transaction for [com.example.JPA.study.springtx.exception.code.RollbackService.runtimeException]
    ...
    fun checkedException() {
         ...
         * Getting transaction for [com.example.JPA.study.springtx.exception.code.RollbackService.checkedException]
         * call checkedException
         * com.example.JPA.study.springtx.exception.code.MyException
    ...
    fun rollbackFor() {
         ...
         * LOG:
         *
         * PROPAGATION_REQUIRED,ISOLATION_DEFAULT,-com.example.JPA.study.springtx.exception.code.MyException
         ...
         * Getting transaction for [com.example.JPA.study.springtx.exception.code.RollbackService.rollbackFor]
         * call rollbackFor
         * com.example.JPA.study.springtx.exception.code.MyException
